...
mapbox_token = "pk.eyJ1IjoibWF4aW1lLWd1aW5vdCIsImEiOiJjbHB3bjh4ZGUwaHhnMm9udWY1cGdyaHRxIn0.nvIVwxGyLYp8RNekRUOCSw"
...
def update_review_chart(ds, clustering_type):
    ...
    if clustering_type == "rating-cluster":
        ...
        dff_t[review_columns[0:]] = dff_t[review_columns[0:]] * 20
